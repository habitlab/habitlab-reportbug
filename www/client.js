...
(function(){
  var $, co, getUrlParameters, params, log;
  $ = require('jquery');
  co = require('co');
  ...
  log = function(msg){
    console.log(msg);
    return $('#message_log').append($('<div>').text(JSON.stringify(msg)));
  };
  co(function*(){
    var img_data_base64, data;
    if (!params.run) {
