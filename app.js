...
(function(){
  var koa, koaRouter, koaLogger, koaBodyparser, koaJsonp, sendgrid, kapp, app, helper, getsecret, sg, default_from_email, default_to_email, port, ref$;
  koa = require('koa');
  ...
  app.get('/send_test_email', function*(){
    var from_email, to_email, subject, img_data_base64, content, mail, attachment, request, response;
    this.type = 'json';
