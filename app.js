...
(function(){
  var koa, koaRouter, koaLogger, koaBodyparser, koaJsonp, sendgrid, kapp, app, helper, getsecret, sg, default_from_email, default_to_email, cloudinary, Gitter, gitter, ref$, add_noerr, cfy, co, img_data_base64, upload_to_cloudinary, port;
  koa = require('koa');
  ...
  upload_to_cloudinary = cfy(function*(img_data){
    var img_data_url, result;
