...
(function(){
  var koa, koaRouter, koaLogger, koaBodyparser, koaJsonp, koaStatic, sendgrid, btoa, jsyaml, normalize_space, text_clipper, kapp, app, helper, getsecret, sg, default_from_email, default_to_email, cloudinary, Gitter, gitter, Octokat, octo, ref$, add_noerr, cfy, co, upload_to_cloudinary, upload_to_cloudinary_json, port;
  koa = require('koa');
